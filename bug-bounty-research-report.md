...
|------|---------|---------|
| **Superbet** | $100 - $10k | - |
| **Robinhood** | $50 - $25k | Campaign: 最高 $50k (×2) |
| **Playtika** | $100 - $5k | Campaign: 最高 $10k (×2) |
| **Superhuman (Grammarly)** | $100 - $100k | Campaign: 最高 $150k (×1.5) |
| **DoorDash** | $50 - $12k | - |
...
### 自动化工具与数据源
- **bounty-targets-data** (GitHub: arkadiyt/bounty-targets-data)
  - 每小时自动更新各平台 scope
  - 包含 domains.txt / wildcards.txt
...
- **补天** (BuTian)
  - 网址: https://butian.360.cn/
  - 特点: 360 旗下漏洞响应平台
  - 语言: 中文
  
- **阿里云先知** (Xianzhi)
  - 网址: https://xianzhi.aliyun.com/
  - 特点: 阿里巴巴安全响应中心
  - 语言: 中文

**注意：** 亚洲平台通常要求中文报告，赏金以人民币计价。
